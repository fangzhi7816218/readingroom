...
<div class="leftlaycenter">
	...
	<h3 class="sortleftttcenter bgicon01_center">我的书架：</h3>
         <ul>
          <li id="6" class="linormal_center"><a href="/Home/Personal/collect.html">我的收藏</a></li>
         ...
         <ul  style="border-bottom:none;">
			<li id="3" class="linormal_center"><a href="/Home/Personal/index.html">个人中心</a></li>
          <li id="7" class="linormal_center"><a href="/Home/Personal/change_info.html">修改个人信息</a></li>
...
<div class="clear"></div>
		 ...
		 <table width="600" border="0" style="border:1px solid #ffffff;" align="center" cellspacing="0" cellpadding="0">
	<form enctype="multipart/form-data" name="formeditpass" id="formeditpass" action="/Home/Personal/change_info.html?id={userdata['id']}" method="post">
    
      <tr>
        <td width="100" height="30">帐户名称</td>
        <td width="200" height="30"> <input name=username value="<?php echo ($userinfo['username']); ?>"  class=zhifutxtn readonly></td>
        <td height="30" colspan="2"></td>
      </tr>
      <tr>
        <td height="30">真实姓名:</td>
        <td height="30"><input type="text" name="truename" value="<?php echo ($userinfo['truename']); ?>"  class=zhifutxtn size="18"/></td>
        <td height="30" colspan="2"></td>
      </tr>
	  <tr>
        <td height="30">原密码</td>
        <td height="30"><input  type="password"  name="passwd_old"  class=zhifutxtn size="18" /></td>
        <td height="30" colspan="2">&nbsp;</td>
      </tr>
      <tr>
        <td height="30">新密码</td>
        <td height="30"><input  type="password"  name="passwd"  class=zhifutxtn size="18" /></td>
        <td height="30" colspan="2">数字、英文、下划线均可,6个字符</td>
      </tr>
      <tr>
        <td height="30">确认密码</td>
        <td height="30"><input type="password" name="passwd2"  class=zhifutxtn size="18"/></td>
        <td height="30" colspan="2">请重复填写密码</td>
      </tr>
      <tr>
        <td height="30">email</td>
        <td height="30"><input type="text" name="email" value="<?php echo ($userinfo['email']); ?>"  class=zhifutxtn size="18"/></td>
        <td height="30" colspan="2"></td>
      </tr>
      <tr>
        <td height="30">联系电话</td>
        <td height="30"><input type="text" name="phone" value="<?php echo ($userinfo['phone']); ?>" class=zhifutxtn size="18"/></td>
        <td height="30" colspan="2"></td>
      </tr>
      <tr>
        <td height="30">上传头像</td>
        <td height="30"><input type="file" name="img"  class=zhifutxtn size="18"/>
        <?php if(!empty($userinfo['img'])): ?><img src="<?php echo ($userinfo['img']); ?>" /><?php endif; ?>
        </td>
        <td height="30" colspan="2">上传头像支持：jpg.jpep.gif.pne</td>
      </tr>
      <tr>
      	<td></td>
        <td colspan="2" style="height:50px;"><input type="submit" width="100px" height="26" border="0"  name="editpass" /></td>
      </tr>
