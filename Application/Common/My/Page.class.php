...
class Page {
	...
	protected $myconfig  =	array('header'=>'条记录','prev'=>'上一页','next'=>'下一页','first'=>' &nbsp; 首 页 &nbsp; ','last'=>' &nbsp; 末 页 &nbsp; ','theme'=>'<div class="oth"> 共 %totalRow% %header%， %listRows% 条记录每页，第%nowPage%/%totalPage% 页</div><div  class="page"> <span>跳至<input class="read_text" name="p" type="text" value=" curpage" />页<input class="gon" name="" type="submit" value="确定" /></span> <span> %first% %upPage%  %prePage%  %linkPage%  %nextPage% %downPage% %end%</span></div>');
    // 默认分页变量名
    protected $varPage;
